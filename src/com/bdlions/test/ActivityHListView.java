...
public class ActivityHListView extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_hlistview_main);
        list=(HListView)findViewById(R.id.list);
        adapter=new HListAdapter(this, mStrings);
